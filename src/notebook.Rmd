...
`Annual CO2 emissions` is a continueus numerical data representing CO2 emission in tons. There is no NA's but range from 0 to 3.712e+10.
...
While looking at the correlation between Co2 emission and annual land temperatures, there is a clear positive correlation between the two variables. However, the correlation is not strong enough to make any clear inferenes of Co2 emissions affecting the land temperature. Rather it seems probable there are also other varibales which should be included in such an analysis. There is opportunity to build on the current research with the intergration of further datasets.
