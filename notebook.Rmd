...
```
Find temperature change from 1913 - 2012 of each country
...
Find total CO2 emission from 1913 - 2012 of each country
...
Combine estimated temperature changes and CO2 emission for each country from 1913 - 2012
...
ggplot(countryTemperatureChangeAndEmission,
  ...
  geom_vline(xintercept = mean(countryTemperatureChangeAndEmission$`CO2 emissions (MT)`)) +
  geom_hline(yintercept = mean(countryTemperatureChangeAndEmission$`Temperature change`))
```
